 ...
 * 
 */
package com.test.devdown.dao.impl;

import com.test.devdown.dao.EmployeeDAO;
import com.test.devdown.entity.Employee;
import com.test.devdown.util.HibernateUtil;
...
public class EmployeeDAOImpl implements EmployeeDAO {
    ...
    public List<Employee> getAllEmployees(String employeeName) { 
        ...
        //toto som iba vytiahol z comentu lebo vypisovalo chybu
