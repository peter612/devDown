package com.test.devdown.controller;
import com.test.devdown.entity.Employee;
import com.test.devdown.service.EmployeeService;
...
public class EmployeeController {
    ...
    public ModelAndView helloWorld(){
            String message = "<br><div style='text-align:center;'>"
                            + "<h3>*** Hello World, Spring MVC Test***</h3><br><p>***This message is coming from MyController.java***<p></div><br><br>";
            return new ModelAndView("employeeList", "message", message);
    }
